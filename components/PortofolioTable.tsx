...
const PortfolioTable: React.FC<PortfolioTableProps> = ({ portfolioData, stockData }) => {
  ...
  return (
    ...
    <div className="overflow-x-auto rounded-xl shadow-md border border-gray-300">
        ...
        <h2 className="text-xl font-semibold border border-gray-400 rounded-lg px-2 py-1 text-blue-500 filter  drop-shadow-[0_4px_6px_rgba(59,130,246,0.6">Stock Portfolio</h2>
    <table className="min-w-full text-sm text-gray-800">
      <thead className="bg-gray-100 text-xs text-gray-600 uppercase tracking-wider">          <tr>
